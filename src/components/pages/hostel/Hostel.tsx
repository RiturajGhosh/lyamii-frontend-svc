      ...
      <Container className="min-vh-100 align-items-center d-flex">
        <Col className="gap-2 d-flex flex-column">
          ...
          <Row className="d-flex">
            <Col className="justify-content-center d-flex col-8 flex-column">
              <Col className="justify-content-start d-flex">
                <span className="h3 w-30 text-dark p-0 m-0 max-content system-ui">
                  HOSTEL NAME:
                </span>
          ...
          <Row className="d-flex">
            <Col className="justify-content-center d-flex col-10 flex-column">
              <Col className="justify-content-start d-flex">
